...
var bird, slingShot;
var bg = "bg/sunny-bg.jpg"
var score = 0

function preload() {
 backgroundImg = loadImage("bg/sunny-bg.jpg")
 getTime()
}
...
function setup(){
    ...
    box13 = new Box (960, 310, 50, 50)
    box14 = new Box (1012, 310, 50, 50)
